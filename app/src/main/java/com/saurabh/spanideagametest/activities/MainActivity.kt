...
import com.saurabh.spanideagametest.utils.*


class MainActivity : AppCompatActivity(), GameSpanIdea {

    private var x1 = 0f
    private var y1 = 0f
    private lateinit var game: GameCalculationDigit
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i("Log", "Inside on create main activity method")
        ...
        if (savedInstanceState != null) {
            val tmpGame : GameCalculationDigit? = savedInstanceState.getSerializable(GAME_KEY) as GameCalculationDigit
            if (tmpGame != null) {
                game = tmpGame
                game.replotBoard()
            }
        } else {
            game = GameCalculationDigit(this)
            this.setupNewGame()
        }
    }

    override fun onSaveInstanceState(outState: Bundle) {
        Log.i("Log", "Inside onSaveInstanceState method")
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle?) {
        ...
        Log.i("Log", "Inside onRestoreInstanceState method")
        if (savedInstanceState != null) {
            val tmpGame :GameCalculationDigit? = savedInstanceState.getSerializable(GAME_KEY) as GameCalculationDigit
            if (tmpGame != null) {
                game = tmpGame
    ...
    fun onClick(view: View) {
        Log.i("Log", "Inside on click main activity action method")
        this.setupNewGame()
    }
